...
3. 各日3〜5件程度を目安に、移動時間を含めて無理のない順序にする。
...
7. title/summary/audience/transport/sources を含む完全な旅程JSONを返す。
"""
...
4. 各日3〜5件程度。schedule.time は原則 HH:MM-HH:MM。
5. URLは検索コンテキストに明示されたものだけを使う。
6. DayBundle JSONだけを返す。
"""
